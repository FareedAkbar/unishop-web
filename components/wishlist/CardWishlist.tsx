      ...
      <table className="w-full border">
        <thead>
          <tr className="border">
            ...
            <th className="px-6 py-3 text-center max-lg:px-2">Unit Price</th>
            <th className="px-6 py-3 text-center max-lg:px-2">Date Added</th>
            <th className="px-6 py-3 text-center max-lg:px-0">Stock Status</th>
            <th className="w-16"></th>
          </tr>
        </thead>
        <tbody>
          <tr className="">
            ...
            <td className="px-6 max-lg:px-1 max-md:text-sm py-4 text-left">
              Red Indigenous Coat
            </td>
            <td className="px-6 max-lg:px-1 max-md:text-sm py-4 text-center">
              $10.99
            </td>
            <td className="px-6 max-lg:px-1 max-md:text-sm py-4 text-center">
              October 14, 2023
