      ...
      <div className="bg-[#ED1C29] w-full  ">
        <div className="p-5">
          ...
          <div className="flex gap-3 mt-5">
            ...
            <div className=" max-sm:text-[12px]  text-white text-md font-normal font-['Poppins']">
              4221 8050
            </div>
          </div>
          <div className="flex gap-3 mt-5 sm:items-center">
            ...
            <p className="w-auto max-sm:text-[12px] text-white text-sm ">
          ...
          <div className="text-white text-2xl   max-sm:text-sm font-semibold font-['Poppins'] border-b border-t mt-5 py-2">
            Specialty Inquiries
          </div>
          <p className="text-white text-md max-sm:text-[12px] mt-3">
