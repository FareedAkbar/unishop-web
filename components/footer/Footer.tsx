...
const Footer = () => {
  return (
    <>
        ...
        <div className="container  p-10 ">
          <div className="flex max-sm:flex-col gap-16 max-sm:gap-0">
            <div>
              ...
              <div className="text-black  dark:text-white text-lg pt-3 font-medium font-['Poppins'] leading-7">
                Monday - Friday <br />
                (08:30AM - 05:00PM){" "}
              </div>
              <div className="text-black dark:text-white text-sm font-normal font-['Poppins'] leading-normal">
            ...
            <div className="flex  justify-between w-full flex-wrap font-['Poppins']  mt-3 ">
              {footerConfig.map((item, index) => (
                <div key={index} className="mb-5">
                  <p className="text-[1.25rem] font-bold ">{item.header}</p>
                  <ul className="flex flex-col">
                    {item.subItems.map((subitem, subIndex) => (
                      <li key={subIndex} className="  text-[1rem] w-44 mt-3 ">
                        {subitem.header}
                      </li>
                    ))}
                  </ul>
      ...
      <p className="text-[1rem] flex justify-center py-5 font-['Poppins']">
