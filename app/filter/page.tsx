...
const page = () => {
  ...
  return (
    <div className="container">
      ...
      <div className="flex justify-end max-sm:justify-center  flex-wrap  pt-10 ">
      ...
      <div className=" flex  pt-5 max-md:flex-col max-md:items-center gap-10 ">
        ...
        <div className=" flex flex-wrap w-full">
          <div className="flex flex-wrap  font-['Poppins'] justify-center items-center overflow-hidden  ">
