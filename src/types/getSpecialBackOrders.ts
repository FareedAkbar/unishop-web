...
interface GetSpecialOrder {
    ...
    order_status: number;
    order_type: number;
    total_order_price: number | null; // Assuming this could be a number
    total_discounted_price?: number | null; // Assuming this could be a number
...
export type {GetSpecialOrderApiResponse,GetSpecialOrder,SpecialOrderItem,OrderStatusResponse,OrderStatus,UpdateSpecialOrderPayload}