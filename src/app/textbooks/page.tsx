  ...
  return (
    <div>
       ...
       <div className="grid h-[40rem] w-full lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 items-center justify-between">
         ...
         <h2 className="font-serif mr-5 ml-5 mx-auto text-xl relative z-20 md:text-3xl lg:text-5xl font-bold text-center text-black dark:text-white tracking-tight">
