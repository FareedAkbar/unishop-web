...
export default function ProductCardSkeleton() {
  return (
    <div className="flex w-full flex-shrink-0 grow-0 flex-col xs:w-56 sm:w-64 lg:w-72">
      {/* Image Placeholder */}
      <div className="relative w-full animate-pulse">
        <div className="mb-2 h-40 w-full flex-shrink-0 grow-0 rounded bg-gray-200 dark:bg-gray-600 xs:w-56 sm:h-48 sm:w-48 lg:h-56 lg:w-56 xl:h-64 xl:w-64" />
      </div>
