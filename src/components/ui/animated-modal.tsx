      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ref={modalRef}
            className={cn(
              "relative z-50 flex max-h-[90%] min-h-fit flex-1 flex-col overflow-hidden border border-transparent bg-white dark:border-neutral-800 dark:bg-slate-800 md:max-w-[40%] md:rounded-2xl",
              className,
            )}
            initial={{
              opacity: 0,
